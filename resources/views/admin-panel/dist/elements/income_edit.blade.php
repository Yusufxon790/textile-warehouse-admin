...
<body>
    <div class="container">
        <h2 class="alert alert-secondary text-center" >Maxsulotga Miqdor Qo'shish</h2>
        ...
        <div class="d-flex justify-content-center" style="margin-top: 20px;" >
            <form action="{{ route('incomes.update',['income'=>$income->id]) }}" method="POST" style="width: 500px;background-color: lightblue;border-radius:10px;" class="p-5" >
                @csrf
                @method('put')
